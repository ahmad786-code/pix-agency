...
function ServiceAnim1() {
  ...
  const playAnimation = () => {
    ...
    let tl = anime.timeline({
      ...
      complete: () => {
        ...
        const letters = document.querySelectorAll('.effect2 .letter');
  ...
  return (
    <div className="container2">
      ...
      <h1 className={`text-[#e35270] my-4 text-3xl text-center effect2 ${isAnimating ? 'animating' : ''}`}>
        Top-tier management agency elevating digital content creators
      </h1>
